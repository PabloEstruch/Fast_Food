-- Insertar datos en Categorias ------------ 1hs 27min
...
INSERT INTO Mensajeros (Nombre, Externo) VALUES
...
--DELETE FROM Ordenes   11/1/25 Error OrdenID2 
--WHERE OrdenID = 1;

---DELETE FROM Ordenes;   -Luego de borrar todas las filas de la tabla y volverlas a insertar la columna "OrdenID" siguio contando las columnas

---DBCC CHECKIDENT ('Ordenes', RESEED, 0);   -Comando para reiniciar la funcion IDENTITY
...
---¿Cuáles son las sucursales con un promedio de Facturación/Ingresos superior a 1000.00
---y que minimizan sus costos en base al promedio de kilómetros recorridos de todas de sus
---entregas gestionadas? Para un mejor relevamiento, ordene el listado por el Promedio Km Recorridos.
